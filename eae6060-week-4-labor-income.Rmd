...
knitr::include_graphics("figs/aula-4-grafico-28.png")
```

In a linear budget set (dashed line), workers with different abilities $n$ choose different levels of taxable income &mdash; but a piecewise linear tax system creates **kinks**, where nonconvexities cause workers with different abilities to choose the same amount of earnings (**bunching**) `r Citep(myBib, "kleven2016bunching")`
